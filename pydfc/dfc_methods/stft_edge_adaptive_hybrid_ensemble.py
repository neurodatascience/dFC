...
class STFT_EDGE_ADAPTIVE_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of STFTCoherence, EdgeCoactivation, AdaptiveExponentialWindow."""

    MEASURE_NAME = "StftEdgeAdaptive_hybrid_ensemble"
    COMPONENTS = ['Time-Freq', 'EdgeCoactivation', 'AdaptiveExponentialWindow']
