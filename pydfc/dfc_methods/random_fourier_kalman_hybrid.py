...
class RANDOM_FOURIER_KALMAN_HYBRID(BaseDFCMethod):
    """State-free hybrid of RandomFourierDependence, KalmanCovariance, ExponentialWindow."""

    MEASURE_NAME = "RandomFourierKalman_hybrid"
    COMPONENTS = ['RandomFourierDependence', 'KalmanCovariance', 'ExponentialWindow']
    HYBRID_RULE = "kernel_modulated"
