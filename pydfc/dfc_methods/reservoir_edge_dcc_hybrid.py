...
class RESERVOIR_EDGE_DCC_HYBRID(BaseDFCMethod):
    """State-free hybrid of ReservoirEchoStateFC, EdgeCoactivation, DCCConnectivity."""

    MEASURE_NAME = "ReservoirEdgeDcc_hybrid"
    COMPONENTS = ['ReservoirEchoStateFC', 'EdgeCoactivation', 'DCCConnectivity']
    HYBRID_RULE = "state_modulated"
