...
class STFT_EXP_KALMAN_HYBRID(BaseDFCMethod):
    """State-free hybrid of STFTCoherence, ExponentialWindow, KalmanCovariance."""

    MEASURE_NAME = "StftExpKalman_hybrid"
    COMPONENTS = ['STFTCoherence', 'ExponentialWindow', 'KalmanCovariance']
    HYBRID_RULE = "spectral_gate"
