...
class DCC_CHANGEPOINT_SPARSE_HYBRID(BaseDFCMethod):
    """State-free hybrid of DCCConnectivity, ChangepointResetWindow, SparseCoactivationCodeFC."""

    MEASURE_NAME = "DccChangepointSparse_hybrid"
    COMPONENTS = ['DCCConnectivity', 'ChangepointResetWindow', 'SparseCoactivationCodeFC']
    HYBRID_RULE = "change_sparse_gate"
