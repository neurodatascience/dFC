...
class DCC_EDGE_EXPONENTIAL_HYBRID(BaseDFCMethod):
    """State-free hybrid of DCCConnectivity, EdgeCoactivation, ExponentialWindow."""

    MEASURE_NAME = "DccEdgeExponential_hybrid"
    COMPONENTS = ['DCCConnectivity', 'EdgeCoactivation', 'ExponentialWindow']
    HYBRID_RULE = "conditional_residual"
