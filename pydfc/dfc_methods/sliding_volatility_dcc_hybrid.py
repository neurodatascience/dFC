...
class SLIDING_VOLATILITY_DCC_HYBRID(BaseDFCMethod):
    """State-free hybrid of SlidingWindow, VolatilityWeightedFC, DCCConnectivity."""

    MEASURE_NAME = "SlidingVolatilityDcc_hybrid"
    COMPONENTS = ['SlidingWindow', 'VolatilityWeightedFC', 'DCCConnectivity']
    HYBRID_RULE = "volatility_residual"
