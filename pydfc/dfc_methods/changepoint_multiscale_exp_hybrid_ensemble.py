...
class CHANGEPOINT_MULTISCALE_EXP_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of ChangepointResetWindow, MultiscaleWindow, ExponentialWindow."""

    MEASURE_NAME = "ChangepointMultiscaleExp_hybrid_ensemble"
    COMPONENTS = ['ChangepointResetWindow', 'MultiscaleWindow', 'ExponentialWindow']
