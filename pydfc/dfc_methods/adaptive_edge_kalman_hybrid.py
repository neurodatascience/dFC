...
class ADAPTIVE_EDGE_KALMAN_HYBRID(BaseDFCMethod):
    """State-free hybrid of AdaptiveExponentialWindow, EdgeCoactivation, KalmanCovariance."""

    MEASURE_NAME = "AdaptiveEdgeKalman_hybrid"
    COMPONENTS = ['AdaptiveExponentialWindow', 'EdgeCoactivation', 'KalmanCovariance']
