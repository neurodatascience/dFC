...
class DIFFERENTIAL_EDGE_KALMAN_HYBRID(BaseDFCMethod):
    """State-free hybrid of DifferentialCoactivationFC, EdgeCoactivation, KalmanCovariance."""

    MEASURE_NAME = "DifferentialEdgeKalman_hybrid"
    COMPONENTS = ['DifferentialCoactivationFC', 'EdgeCoactivation', 'KalmanCovariance']
    HYBRID_RULE = "derivative_gate"
