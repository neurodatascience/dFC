...
class DCC_KALMAN_VOLATILITY_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of DCCConnectivity, KalmanCovariance, VolatilityWeightedFC."""

    MEASURE_NAME = "DccKalmanVolatility_hybrid_ensemble"
    COMPONENTS = ['DCCConnectivity', 'KalmanCovariance', 'VolatilityWeightedFC']
