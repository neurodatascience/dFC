"""Pooled k-means state-based dFC."""
...
class POOLED_KMEANS_STATES(BaseDFCMethod):
    ...
    def _subject_chunks(self, time_series):
        return [
    ...
    def estimate_FCS(self, time_series):
        ...
        chunks = self._subject_chunks(time_series)
        ...
        labels_chunks = [self.kmeans_.predict(chunk).astype(int) for chunk in chunks]
