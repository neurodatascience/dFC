...
class MULTISCALE_DCC_KALMAN_HYBRID(BaseDFCMethod):
    """State-free hybrid of MultiscaleWindow, DCCConnectivity, KalmanCovariance."""

    MEASURE_NAME = "MultiscaleDccKalman_hybrid"
    COMPONENTS = ['MultiscaleWindow', 'DCCConnectivity', 'KalmanCovariance']
    HYBRID_RULE = "multiscale_residual"
