...
class EDGE_STFT_QUANTUM_HYBRID(BaseDFCMethod):
    """State-free hybrid of EdgeCoactivation, STFTCoherence, QuantumMutualInformationFC."""

    MEASURE_NAME = "EdgeStftQuantum_hybrid"
    COMPONENTS = ['EdgeCoactivation', 'Time-Freq', 'QuantumMutualInformationFC']
    HYBRID_RULE = "spectral_information_gate"
