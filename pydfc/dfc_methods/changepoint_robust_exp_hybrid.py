...
class CHANGEPOINT_ROBUST_EXP_HYBRID(BaseDFCMethod):
    """State-free hybrid of ChangepointResetWindow, RobustSlidingWindow, ExponentialWindow."""

    MEASURE_NAME = "ChangepointRobustExp_hybrid"
    COMPONENTS = ['ChangepointResetWindow', 'RobustSlidingWindow', 'ExponentialWindow']
    HYBRID_RULE = "change_reset_gate"
