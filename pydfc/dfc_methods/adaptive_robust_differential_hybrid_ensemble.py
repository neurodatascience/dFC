...
class ADAPTIVE_ROBUST_DIFFERENTIAL_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of AdaptiveExponentialWindow, RobustSlidingWindow, DifferentialCoactivationFC."""

    MEASURE_NAME = "AdaptiveRobustDifferential_hybrid_ensemble"
    COMPONENTS = ['AdaptiveExponentialWindow', 'RobustSlidingWindow', 'DifferentialCoactivationFC']
