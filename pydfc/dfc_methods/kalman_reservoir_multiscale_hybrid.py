...
class KALMAN_RESERVOIR_MULTISCALE_HYBRID(BaseDFCMethod):
    """State-free hybrid of KalmanCovariance, ReservoirEchoStateFC, MultiscaleWindow."""

    MEASURE_NAME = "KalmanReservoirMultiscale_hybrid"
    COMPONENTS = ['KalmanCovariance', 'ReservoirEchoStateFC', 'MultiscaleWindow']
    HYBRID_RULE = "state_multiscale_residual"
