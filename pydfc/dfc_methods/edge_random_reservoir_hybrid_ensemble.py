...
class EDGE_RANDOM_RESERVOIR_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of EdgeCoactivation, RandomFourierDependence, ReservoirEchoStateFC."""

    MEASURE_NAME = "EdgeRandomReservoir_hybrid_ensemble"
    COMPONENTS = ['EdgeCoactivation', 'RandomFourierDependence', 'ReservoirEchoStateFC']
