...
class ADAPTIVE_RANDOM_SPARSE_HYBRID(BaseDFCMethod):
    """State-free hybrid of AdaptiveExponentialWindow, RandomFourierDependence, SparseCoactivationCodeFC."""

    MEASURE_NAME = "AdaptiveRandomSparse_hybrid"
    COMPONENTS = ['AdaptiveExponentialWindow', 'RandomFourierDependence', 'SparseCoactivationCodeFC']
    HYBRID_RULE = "sparse_kernel_gate"
