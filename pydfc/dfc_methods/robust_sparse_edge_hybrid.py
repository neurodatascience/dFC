...
class ROBUST_SPARSE_EDGE_HYBRID(BaseDFCMethod):
    """State-free hybrid of RobustSlidingWindow, SparseCoactivationCodeFC, EdgeCoactivation."""

    MEASURE_NAME = "RobustSparseEdge_hybrid"
    COMPONENTS = ['RobustSlidingWindow', 'SparseCoactivationCodeFC', 'EdgeCoactivation']
    HYBRID_RULE = "sparse_residual"
