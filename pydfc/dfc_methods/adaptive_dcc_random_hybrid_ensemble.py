...
class ADAPTIVE_DCC_RANDOM_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of AdaptiveExponentialWindow, DCCConnectivity, RandomFourierDependence."""

    MEASURE_NAME = "AdaptiveDccRandom_hybrid_ensemble"
    COMPONENTS = ['AdaptiveExponentialWindow', 'DCCConnectivity', 'RandomFourierDependence']
