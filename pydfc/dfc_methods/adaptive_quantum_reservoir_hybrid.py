...
class ADAPTIVE_QUANTUM_RESERVOIR_HYBRID(BaseDFCMethod):
    """State-free hybrid of AdaptiveExponentialWindow, QuantumMutualInformationFC, ReservoirEchoStateFC."""

    MEASURE_NAME = "AdaptiveQuantumReservoir_hybrid"
    COMPONENTS = ['AdaptiveExponentialWindow', 'QuantumMutualInformationFC', 'ReservoirEchoStateFC']
    HYBRID_RULE = "information_state_gate"
