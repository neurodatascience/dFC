...
class ROBUST_DIFFERENTIAL_STFT_HYBRID(BaseDFCMethod):
    """State-free hybrid of RobustSlidingWindow, DifferentialCoactivationFC, STFTCoherence."""

    MEASURE_NAME = "RobustDifferentialStft_hybrid"
    COMPONENTS = ['RobustSlidingWindow', 'DifferentialCoactivationFC', 'Time-Freq']
    HYBRID_RULE = "robust_spectral_derivative"
