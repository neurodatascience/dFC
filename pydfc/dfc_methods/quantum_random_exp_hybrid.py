...
class QUANTUM_RANDOM_EXP_HYBRID(BaseDFCMethod):
    """State-free hybrid of QuantumMutualInformationFC, RandomFourierDependence, ExponentialWindow."""

    MEASURE_NAME = "QuantumRandomExp_hybrid"
    COMPONENTS = ['QuantumMutualInformationFC', 'RandomFourierDependence', 'ExponentialWindow']
    HYBRID_RULE = "information_gate"
