...
class STFT_QUANTUM_SPARSE_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of STFTCoherence, QuantumMutualInformationFC, SparseCoactivationCodeFC."""

    MEASURE_NAME = "StftQuantumSparse_hybrid_ensemble"
    COMPONENTS = ['Time-Freq', 'QuantumMutualInformationFC', 'SparseCoactivationCodeFC']
