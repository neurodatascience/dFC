...
class VOLATILITY_ADAPTIVE_EDGE_HYBRID(BaseDFCMethod):
    """State-free hybrid of VolatilityWeightedFC, AdaptiveExponentialWindow, EdgeCoactivation."""

    MEASURE_NAME = "VolatilityAdaptiveEdge_hybrid"
    COMPONENTS = ['VolatilityWeightedFC', 'AdaptiveExponentialWindow', 'EdgeCoactivation']
    HYBRID_RULE = "volatility_gate"
