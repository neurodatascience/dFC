...
class ROBUST_VOLATILITY_SLIDING_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of RobustSlidingWindow, VolatilityWeightedFC, SlidingWindow."""

    MEASURE_NAME = "RobustVolatilitySliding_hybrid_ensemble"
    COMPONENTS = ['RobustSlidingWindow', 'VolatilityWeightedFC', 'SlidingWindow']
