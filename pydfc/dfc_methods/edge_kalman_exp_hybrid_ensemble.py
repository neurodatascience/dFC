...
class EDGE_KALMAN_EXP_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of EdgeCoactivation, KalmanCovariance, ExponentialWindow."""

    MEASURE_NAME = "EdgeKalmanExp_hybrid_ensemble"
    COMPONENTS = ['EdgeCoactivation', 'KalmanCovariance', 'ExponentialWindow']
