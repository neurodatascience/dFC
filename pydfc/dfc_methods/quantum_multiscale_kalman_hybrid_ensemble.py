...
class QUANTUM_MULTISCALE_KALMAN_HYBRID_ENSEMBLE(BaseDFCMethod):
    """State-free hybrid of QuantumMutualInformationFC, MultiscaleWindow, KalmanCovariance."""

    MEASURE_NAME = "QuantumMultiscaleKalman_hybrid_ensemble"
    COMPONENTS = ['QuantumMutualInformationFC', 'MultiscaleWindow', 'KalmanCovariance']
