...
_ALIASES: Dict[str, List[str]] = {
    ...
    "AdaptiveDcccombo": ["adcccombo"],
    "AdaptiveMultiscalecombo": ["amscombo"],
    ...
    "AdaptiveRandomFouriercombo": ["arfc"],
    "RandomFourierDcccombo": ["rfdcccombo"],
    "RandomFourierTimeFreqcombo": ["rftfcombo"],
    ...
    "DCCConnectivity": ["dcc"],
    "DccMultiscalecombo": ["dccmscombo"],
    "DccTimeFreqcombo": ["dcctfcombo"],
